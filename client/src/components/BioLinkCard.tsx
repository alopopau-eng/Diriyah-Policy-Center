    ...
    >
      <Card className="p-4 transition-all duration-300 hover:shadow-lg hover:scale-[1.02] border-card-border group-hover:border-primary/30">
        <div className="flex items-center gap-4">
          <div className="flex-shrink-0 p-3 rounded-md bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors duration-300"></div>
